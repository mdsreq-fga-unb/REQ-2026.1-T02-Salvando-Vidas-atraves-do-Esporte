...
!!! info "Navegação passo a passo"
    - **Inativação / Reativação:**  
      `Menu Principal` ➔ `Configurações` ➔ Acesso Painel Admin (`/admin`) ➔ Card *Editar Voluntário* ➔ Lista de Voluntários ➔ Menu Opções (⋮) ➔ Opção **"Inativar"** ou **"Reativar"**
    - **Filtro de Inativos:**  
      `Menu Principal` ➔ `Configurações` ➔ Acesso Painel Admin (`/admin`) ➔ Card *Editar Voluntário* ➔ Ativar Switch *Mostrar inativos*
...
=== "Tela 1"
    ![Protótipo US-29 Tela 1](../assets/prototiposMediaFidelidade/US29_1.png)

=== "Tela 2"
    ![Protótipo US-29 Tela 2](../assets/prototiposMediaFidelidade/US29_2.png)
