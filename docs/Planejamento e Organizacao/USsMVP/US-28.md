...
!!! info "Navegação passo a passo"
    - **Cadastro:**  
      `Menu Principal` ➔ `Configurações` ➔ Acesso Painel Admin (`/admin`) ➔ Card *Cadastrar Voluntário* ➔ Preencher Formulário ➔ Botão **"Salvar"**
    - **Edição:**  
      `Menu Principal` ➔ `Configurações` ➔ Acesso Painel Admin (`/admin`) ➔ Card *Editar Voluntário* ➔ Selecionar Voluntário ➔ Botão **"Salvar"**
...
=== "Tela 1"
    ![Protótipo US-28 Tela 1](../assets/prototiposMediaFidelidade/US28_1.png)

=== "Tela 2"
    ![Protótipo US-28 Tela 2](../assets/prototiposMediaFidelidade/US28_2.png)
