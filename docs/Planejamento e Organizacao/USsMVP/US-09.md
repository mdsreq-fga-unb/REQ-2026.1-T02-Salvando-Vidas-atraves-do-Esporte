...
!!! info "Navegação passo a passo"
      - Menu Principal > Turmas > Selecionar Card da Turma > Botão "Registrar Frequência" > Marcar Presenças nos Checkboxes > Botão "Registrar Frequência" > Modal de Confirmação > Botão "Confirmar"
