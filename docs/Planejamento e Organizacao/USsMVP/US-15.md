...
!!! info "Navegação passo a passo"
      - Menu Principal > Inventário > Botão "Doações & Perdas" > Card Expansível "Registrar uma perda" > Preencher Kimono, Quantidade e Motivo > Botão "Confirmar Perda" > Modal de Confirmação > Botão "Confirmar"
