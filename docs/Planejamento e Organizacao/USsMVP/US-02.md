...
!!! info "Navegação passo a passo"
    - **Edição:**  
      `Menu Principal` ➔ `Pesquisar` ➔ Expandir Card do Aluno ➔ Botão **"Editar Informações"** ➔ Botão **"Salvar Alterações"** ➔ Modal *Confirmação* ➔ Botão **"Confirmar"**
    - **Busca:**  
      `Menu Principal` ➔ `Pesquisar` ➔ Barra de Pesquisa
    - **Inativação:**  
      `Menu Principal` ➔ `Pesquisar` ➔ Expandir Card do Aluno ➔ Menu Opções (⋮) ➔ Opção **"Inativar"**
...
=== "Tela 1"
    ![Protótipo US-02 Tela 1](../assets/prototiposMediaFidelidade/US02_1.png)

=== "Tela 2"
    ![Protótipo US-02 Tela 2](../assets/prototiposMediaFidelidade/US02_2.png)
