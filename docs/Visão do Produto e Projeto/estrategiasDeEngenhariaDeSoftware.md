...
| **Documentação** | Tende a ser menor e menos formal que o Espiral, mas ainda mantém a documentação de requisitos, protótipos e validações como medida de rastreabilidade | Evolui ao longo dos ciclos; começa com descrições de alto nível e refina-se progressivamente; nível de formalidade pode ser adaptado conforme os riscos identificados |
...
1. **Escopo delimitado e modularizável.** O produto é composto por módulos funcionalmente semi-independentes, com o cadastro de alunos como dependência central, com o controle de frequência e gestão de kimonos como módulos independentes. Essa estrutura favorece entregas incrementais e isoladas, característica central do RAD, sem a necessidade de ciclos extensos de análise de riscos que o Espiral demandaria.
