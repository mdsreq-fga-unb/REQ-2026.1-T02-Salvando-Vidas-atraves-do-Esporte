...
| Analista de QA | Garante a qualidade do produto, executando testes de funcionalidade, performance e usabilidade. | Pedro Lucas | Pedro Ramos |
| Analista de Requisitos | Define os requisitos funcionais e não funcionais do sistema e garante que eles sejam atendidos. | Lucas Oliveira | Giovani de Oliveira; José Augusto; Júlia Siqueira; Pedro Lucas; Pedro Ramos |
