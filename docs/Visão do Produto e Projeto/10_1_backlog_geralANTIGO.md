...
=== "Tema: Acompanhamento Pedagógico e Engajamento"
    ...
    | US-22 | Como **Voluntário**, quero navegar pelos registros pedagógicos de um aluno em ordem cronológica, para acompanhar como seu desenvolvimento evoluiu no projeto. | RF26 | - |
...
=== "Tema: Gestão de Usuários e Acessos"
    ...
    | ID da US | História de Usuário | RFs Relacionados | RNFs Relacionados |
    | :---: | :--- | :---: | :---: |
    | US-33 | Como **Coordenador**, quero definir o nível de permissão de cada voluntário, para proteger os dados sensíveis dos alunos conforme cada função. | RF40 | - |
