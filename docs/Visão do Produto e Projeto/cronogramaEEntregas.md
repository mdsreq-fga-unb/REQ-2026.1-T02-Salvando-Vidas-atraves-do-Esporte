...
=== "Fase 2 Planejamento de Requisitos + Design do Usuário - Abril-Maio" 
    ...
    | 14/05 - 17/05 (3 dias) | Refinamento da lista de requisitos <br> [Árvore de Rastreabilidade visual](../Visão%20do%20Produto%20e%20Projeto/requisitosDeSoftware.md#arvore)* <br> Matriz Avaliação Técnica × Valor de Negócio <br> priorização quantitativa do MVP | 
    ...
    | Iteração | Data | Atividade ER | Técnica | Descrição | Verificação e Validação |
    | - | - | - | - | - | - |
    | <span id="R2"></span> R2 | 24/04 | Elicitação e Descoberta | Entrevistas e Brainstorming | Reunião com Cliente para alinhar escopo preliminar elicitado <br> Aplicação da técnica [Brainstorming](#Brainstorming)* para descobrimento de mais requisitos | Verificação da lista preliminar das funcionalidades |
